...
class DbusAggBatService(object):
    ...
    def _update(self):
        ...
        ConsumedAmphours = 0
        TimeToGo = 0
        VeDirectShuntConsumedEnergyAh: Optional[float] = None
        ...
        if settings.CURRENT_FROM_VICTRON:
            ...
            try:
                ...
                for vedirect_shunt in self._vedirect_smartshunt_list:
                    ...
                    if VeDirectShuntConsumedEnergyAh is None:
                        VeDirectShuntConsumedEnergyAh = 0
                    VeDirectShuntConsumedEnergyAh += shunt_data.consumed_energy_ah
        ...
        if VeDirectShuntConsumedEnergyAh is not None:
            ConsumedAmphours = VeDirectShuntConsumedEnergyAh
